  ...
  return (
    <div className="flex flex-col items-center min-h-screen px-20 py-12 gap-12 ">
      ...
      <div className="relative w-full h-96 bg-neutral-300 rounded-lg">
        <Image src="https://www.trace-ta-route.com/wp-content/uploads/2020/08/Randonnee-Bauges-Arcalod-24-ascension-Trace-Les-Cimes-1050x700.jpg" alt="head" className="w-full h-full object-cover rounded-lg" layout="fill" />
